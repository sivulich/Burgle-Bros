...
constexpr double TILE_XPOS[4][4] = { { TILE_A1_XPOS,TILE_B1_XPOS,TILE_C1_XPOS,TILE_D1_XPOS },
...
constexpr double TILE_YPOS[4][4] = { { TILE_A1_YPOS,TILE_B1_YPOS,TILE_C1_YPOS,TILE_D1_YPOS },
...
// CONSOLE
constexpr auto CONSOLE_WIDTH = SCREEN_WIDTH-40;
constexpr auto CONSOLE_HEIGHT = 25;
constexpr auto CONSOLE_XPOS = 40;
constexpr auto CONSOLE_YPOS = 25;


constexpr auto ROOF_XPOS = 1200;
constexpr auto ROOF_YPOS = 650;